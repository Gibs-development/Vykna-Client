...
public final class GpuPresenter extends AWTGLCanvas {
    ...
    private boolean debugEnabled = Boolean.getBoolean("gpu.debug");
    ...
    private void renderFrame(RenderContext context) {
        makeContextCurrent();
        ...
        glUniform2f(uniformTexel, 1.0f / context.getBufferWidth(), 1.0f / context.getBufferHeight());
