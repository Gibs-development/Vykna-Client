...
public class SettingsInterface extends RSInterface {
    ...
    public void load(TextDrawingArea[] tda) {
        ...
        SettingsWidgetSection[] sections = {
                new SettingsWidgetSection("Interface Options", INTERFACE_STYLE, OLD_GAMEFRAME, INVENTORY_MENU, BOUNTY_HUNTER, ENTITY_TARGET, GAME_TIMERS, CHAT_EFFECT, GROUND_ITEM_NAMES, PM_NOTIFICATION),
